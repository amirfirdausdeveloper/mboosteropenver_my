...
/**
 * Created by royfei on 20/07/2017.
 */
...
public class DragFloatActionButton extends FloatingActionButton {
    ...
    private void init(){
        ...
        statusHeight=DisplayUtil.getStatuBarHeight((Activity) getContext());
    }
        ...
        switch (event.getAction() & MotionEvent.ACTION_MASK) {
            ...
            case MotionEvent.ACTION_UP:
                if(isDrag){
                    //恢复按压效果
                    setPressed(false);
                    //Log.i("getX="+getX()+"；screenWidthHalf="+String.valueOf(screenWidthHalf));
